...
$fileName = 'dummy-file-' . (new DateTime())->format('YmdHis') . '.txt';
...
// Read the dummy file
$content = $flysystem->read($fileName);
$contentType = $flysystem->mimeType($fileName);
$size = $flysystem->fileSize($fileName);
echo 'File content: ' . $content . "\n";
echo 'File content type: ' . $contentType . "\n";
echo 'File size: ' . $size . " octet(s)\n";
